    ...
    Read and analyze the provided code summaries, and create a detailed final summary of its contents, in markdown format, including:
    ...
    - Use the code syntax and semantics each code is written to understand the code structure and organization.
    ...
    it will be the README.md file of the project.
